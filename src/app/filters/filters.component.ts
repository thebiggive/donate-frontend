...
import { Component, HostListener, Input, Inject, OnInit, PLATFORM_ID } from '@angular/core';
...
export class FiltersComponent implements OnInit {
  ...
  @Input() public categoryOptions: string[];
  @Input() public children: CampaignSummary[];
  @Input() public countryOptions: string[];
  @Input() public filterError = false;
  @Input() public fund: Fund;
  @Input() public hasTerm = false;
  @Input() public selectedSort = 'matchFundsRemaining';

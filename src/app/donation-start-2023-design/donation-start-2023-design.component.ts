...
import { DonationStartMatchConfirmDialogComponent } from './donation-start-2023-design-match-confirm-dialog.component';
import { DonationStartMatchingExpiredDialogComponent } from './donation-start-2023-design-matching-expired-dialog.component';
import { DonationStartOfferReuseDialogComponent } from './donation-start-2023-design-offer-reuse-dialog.component';
...
@Component({
  ...
  templateUrl: './donation-start-2023-design.component.html',
  styleUrls: ['./donation-start-2023-design.component.scss'],
})
